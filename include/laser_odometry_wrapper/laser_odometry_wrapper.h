...
#ifndef SP_A_LOAM_ROS_LASER_ODOMETRY_WRAPPER_H
#define SP_A_LOAM_ROS_LASER_ODOMETRY_WRAPPER_H
#include <ros/ros.h>
...
class laserOdometryWrapper {
public:
    laserOdometryWrapper(loOption option);
    void run();
private:
    ...
    void pclToMsg(const PointTypeStamped::Ptr laser_cloud, sensor_msgs::PointCloud2 &laser_cloud_out_msg);
...
#endif //SP_A_LOAM_ROS_LASER_ODOMETRY_WRAPPER_H
