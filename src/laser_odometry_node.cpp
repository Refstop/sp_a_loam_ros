...
laserOdometryNode::laserOdometryNode(loOption option):
...
void laserOdometryNode::laserCloudSharpHandler(const sensor_msgs::PointCloud2::ConstPtr& corner_points_sharp_msg) {
...
void laserOdometryNode::laserCloudLessSharpHandler(const sensor_msgs::PointCloud2::ConstPtr& corner_points_less_sharp_msg) {
...
void laserOdometryNode::laserCloudFlatHandler(const sensor_msgs::PointCloud2::ConstPtr& surf_points_flat_msg) {
...
void laserOdometryNode::laserCloudLessFlatHandler(const sensor_msgs::PointCloud2::ConstPtr& surf_points_less_flat_msg) {
...
void laserOdometryNode::laserCloudFullResHandler(const sensor_msgs::PointCloud2::ConstPtr& laser_cloud_full_res_msg) {
...
void laserOdometryNode::pclToMsg(const PointCloudStamped::Ptr laser_cloud, sensor_msgs::PointCloud2 &laser_cloud_out_msg) {
